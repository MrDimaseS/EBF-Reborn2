...
function modifier_boss_forest_guardian_leech_seed_debuff:OnIntervalThink()
	...
	for _, enemy in ipairs( caster:FindFriendlyUnitsInRadius( parent:GetAbsOrigin(), self.radius, {type = DOTA_UNIT_TARGET_HERO} ) ) do
...
function modifier_boss_forest_guardian_leech_seed_debuff:GetAttributes()
