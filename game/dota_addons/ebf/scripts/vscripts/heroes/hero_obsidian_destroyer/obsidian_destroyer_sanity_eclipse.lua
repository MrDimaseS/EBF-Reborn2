...
function obsidian_destroyer_sanity_eclipse:OnSpellStart()
	...
	local summon_multiplier = self:GetSpecialValueFor("summon_multiplier")
	...
	for _,enemy in pairs(enemies) do
		local intDamage = self:GetSpecialValueFor("damage_multiplier") * ( caster:GetMana() - enemy:GetMana() )
