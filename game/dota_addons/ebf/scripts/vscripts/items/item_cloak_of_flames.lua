...
function item_cloak_of_flames:OnSpellStart()
...
function modifier_item_cloak_of_flames_passive:GetModifierAttackSpeedBonus_Constant()
...
function modifier_item_cloak_of_flames_passive:OnDeath( params )
