...
function void_spirit_astral_step:GetIntrinsicModifierName()
	return "modifier_void_spirit_astral_step_charges"
end

function void_spirit_astral_step:HasCharges()
	return true
end
...
LinkLuaModifier("modifier_void_spirit_astral_step_debuff", "heroes/hero_void_spirit/void_spirit_astral_step", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_void_spirit_astral_step_charges", "heroes/hero_void_spirit/void_spirit_astral_step", LUA_MODIFIER_MOTION_NONE)
