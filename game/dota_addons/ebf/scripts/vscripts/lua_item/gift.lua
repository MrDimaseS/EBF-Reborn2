...
function gift_open(keys)
	...
	if round>=7 and round <12 then Tier = "T2"
	elseif round>=12 and round <16 then Tier = "T3"
	elseif round >= 16 and round <20 then Tier = "T4"
	elseif round >= 20 and round <24 then Tier = "T5"
	elseif round >= 25 then Tier = "T6"
	end
	print ("tier :",Tier)
