...
function item_soul_ring:OnSpellStart()
...
function modifier_item_soul_ring_passive:GetModifierAttackSpeedBonus_Constant()
...
function modifier_item_soul_ring_passive:OnDeath( params )
