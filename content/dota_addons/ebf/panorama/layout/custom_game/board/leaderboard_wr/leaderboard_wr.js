(function () {
	...
	function updateLeaderboard() {
		...
		var leaderboardData_wr = CustomNetTables.GetTableValue("game_state", "leaderboard_wr");		

		for (var index in leaderboardData_wr) {
			if (leaderboardData_wr.hasOwnProperty(index)) {
				var data = leaderboardData_wr[index];
