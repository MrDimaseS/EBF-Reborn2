...
LinkLuaModifier( "modifier_bh_track", "heroes/hero_bounty_hunter/bounty_hunter_track.lua" ,LUA_MODIFIER_MOTION_NONE )
...
function bounty_hunter_track:OnSpellStart()
	...
	target:AddNewModifier(caster, self, "modifier_bounty_hunter_track", {Duration = self:GetTalentSpecialValueFor("duration")})
	-- self:Track(target)
end
